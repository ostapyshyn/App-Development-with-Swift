...
var stock = ["Chips": 4, "Donuts": 0.9, "Juice": 12, "Apple": 6, "Banana": 6, "Broccoli": 3]

func purchase(item: String) -> Double? {
    if let newItem = stock[item] {
        if newItem > 0 {
            return prices[item]
        } else {
            return nil
