...
class Workout: CustomStringConvertible, Equatable, Comparable, Codable {
    ...
    var description: String {
        return "WorkOut \(distance), \(time), \(identifier)"
    }
 ...
 */
let workout1 = Workout(distance: 4, time: 31, identifier: 1)
print(workout1)

/*:
 Make the `Workout` class above conform to the `Equatable` protocol. Two `Workout` objects should be considered equal if they have the same identifier. Create another instance of `Workout`, giving it an identifier of 2, and print a boolean expression that evaluates to whether or not it is equal to the first `Workout` instance you created.
 */
let workout2 = Workout(distance: 42, time: 12, identifier: 2)
 ...
 */
let workout3 = Workout(distance: 12, time: 12, identifier: 77)
let workout4 = Workout(distance: 22, time: 12, identifier: 45)
let workout5 = Workout(distance: 3, time: 12, identifier: 21)
